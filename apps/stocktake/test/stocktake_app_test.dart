import 'package:stocktake/main.dart';
import 'package:stocktake/navigation/go_router_navigator.dart';
import 'package:stocktake/router.dart';
...
void main() {
  ...
  testWidgets('renders the stock list and opens an item', (tester) async {
    await tester.pumpWidget(const ProviderScope(child: StocktakeApp()));
