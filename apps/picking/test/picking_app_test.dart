...
import 'package:picking/navigation/go_router_navigator.dart';
import 'package:picking/router.dart';
...
void main() {
  ...
  testWidgets('renders the stock list and opens an item', (tester) async {
    await tester.pumpWidget(const ProviderScope(child: PickingApp()));
